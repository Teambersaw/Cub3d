...
CFLAGS=-Wall -Wextra -Werror -I $(INCLUDES) -lXext -lX11 -lm -lz -Lminilibx/ -lmlx_Linux
CFILES=$(addprefix $(SRC_DIR), main.c mlx_utils.c parsing/parsing.c parsing/init_struct.c parsing/parsing_map.c\
